...
public class PageBean {
    ...
    public PageBean setNumPerPage(int numPerPage) {
        this.numPerPage = numPerPage;
        return this;
    }
    ...
    public PageBean setRecordList(List<Object> recordList) {
        this.recordList = recordList;
        return this;
    }
    ...
    public PageBean setBeginPageIndex(int beginPageIndex) {
    ...
    public PageBean setEndPageIndex(int endPageIndex) {
    ...
    public PageBean setCountResultMap(Map<String, Object> countResultMap) {
        this.countResultMap = countResultMap;
        return this;
    }
}
